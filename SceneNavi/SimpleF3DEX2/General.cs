    ...
    class General
    {
        ...
        internal static void PerformModeChanges(F3DEX2Interpreter f3dex2)
        {
            ...
            if (Configuration.RenderTextures)
            {
                ...
                /* Texgen */
                if (Convert.ToBoolean(f3dex2.GeometryMode & (uint)General.GeometryMode.TEXTURE_GEN))
                {
            ...
            /* Culling */
            if (Convert.ToBoolean(f3dex2.GeometryMode & (uint)General.GeometryMode.CULL_BOTH))
            {
                GL.Enable(EnableCap.CullFace);
                if (Convert.ToBoolean(f3dex2.GeometryMode & (uint)General.GeometryMode.CULL_BACK))
            ...
            /* Lighting */
            if (Convert.ToBoolean(f3dex2.GeometryMode & (uint)General.GeometryMode.LIGHTING))
            {
